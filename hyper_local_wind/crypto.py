...
A passphrase (e.g. from the ARCHIVE_KEY env var) is stretched into a 32-byte key
with PBKDF2-HMAC-SHA256, then used with Fernet (AES-128-CBC + HMAC, authenticated).
A fresh random salt is generated per file and prepended to the ciphertext.
"""
